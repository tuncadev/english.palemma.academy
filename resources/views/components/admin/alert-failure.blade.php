<div id="alert-failure" class="hidden mt-6 flex items-center p-4 mb-4 text-red-800 border-t-4 border-red-300 bg-red-50 dark:text-red-400 dark:bg-gray-800 dark:border-red-800" role="alert">
    ...
    <div class="ms-3 text-sm font-medium" id="theFMsg">
        {{$slot}}
    </div>
</div>
