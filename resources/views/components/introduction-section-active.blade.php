...
<li class="rounded-lg rounded-tl-none rounded-bl-none border-r-2 border-y-2 border-gray-200 {{ (Route::currentRouteName() === 'course.introduction') ||  (Route::currentRouteName() === 'course.instructions') ? 'bg-green-300' : 'bg-sky-100' }}">
    <div class="ms-6 py-3 flex flex-col items-center justify-center">
        ...
        <div class="relative flex items-center  mt-2">
            ...
            @endif
            <a class="hover:bg-sky-200 button_steps_sections {{ Route::currentRouteName() === 'course.introduction' ? 'bg-sky-400' : ' bg-white' }}" href="{{ route('course.introduction', ['course_id' => $course_id, 'section_id' => $current_id]) }}">
                @lang('course.intro')
            </a>
        </div>
    </div>
