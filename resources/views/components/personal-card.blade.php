<div class="md:max-w-lg lg:max-w-xl justify-center flex flex-col items-center md:flex-row  p-4 m-auto gap-6">
    ...
    <div class="flex sm:w-1/2 flex-col justify-between leading-normal text-center md:text-start">
        ...
        <p class="mb-3 font-xs text-gray-700 lowercase">
            <a class="text-green-600 hover:text-blue-600 " href="mailto:emma@palemma.academy">emma@palemma.academy</a>
        </p>
    </div>
</div>
