        ...
        <ol class="relative text-sm text-gray-500 border-l-2 border-gray-200 dark:border-gray-700 dark:text-gray-400">
            <li class="rounded-lg rounded-tl-none rounded-bl-none border-r-2 border-y-2 border-gray-200 bg-sky-100">
                <div class="ms-6 py-3">
                    ...
                    <button class="button_steps_sections mt-2 {{ Route::currentRouteName() === 'course.show' ? 'bg-sky-200' : ' bg-white' }}" onclick=""> Course Video</button>
                    <button class="button_steps_sections mt-2 {{ Route::currentRouteName() === 'course.practice' ? 'bg-sky-200' : ' bg-white' }}" onclick="">Intructions</button>
                    <button class="button_steps_sections mt-2 {{ Route::currentRouteName() === 'course.quiz' ? 'bg-sky-200' : ' bg-white' }}" onclick="">Intructions</button>
                </div>
            </li>
