...
<div class=" sm:ml-64">
    ...
    window.checkQuizAnswers = function() {
        ...
        document.getElementById('correct_answers').innerText = `${window.translations.correct}: ${correctCount}`;
        document.getElementById('wrong_answers').innerText = `${window.translations.incorrect}: ${incorrectCount}`;
