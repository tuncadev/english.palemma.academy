    ...
    @section('content')
        ...
        <div class="flex flex-col text-center w-full justify-center pb-4 border-b-2 border-gray-300 m-auto pt-6">
            ...
            <div class="grid grid-cols-1 gap-6 justify-items-center md:pt-4 ">
                ...
                <a href="{{ route('course.tutorials', ['course_id' => $course_id]) }}"
            ...
            @foreach ($localizedSections as $index => $section)
                ...
                @else
                <div class="c_container relative w-full flex relative btn btn-primary course-card px-2 md:px-6 md:py-4  border border-gray-300/80">
                    ...
                    <div class="w-20 set-size charts-container text-center">
                        <i class="text-3xl text-red-300/70 fa-solid fa-lock"></i>
                    </div>
                </div>
                @endif
